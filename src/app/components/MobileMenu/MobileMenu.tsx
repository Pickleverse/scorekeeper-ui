...
const styles = {
    ...
    openMenu: `fixed right-0 bottom-0 transform-gpu translate-y ease-out duration-400 w-full h-50vh  bg-gray-900/50 backdrop-blur-sm shadow-lg `,
    closeMenu: `fixed right-0 -bottom-2000 transform-gpu translate-y ease-in duration-500  w-full h-50vh  bg-gray-900/50 backdrop-blur-sm shadow-lg `,
}
