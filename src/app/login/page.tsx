    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-indigo-700 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">YourBrand</h1>
          <p className="text-purple-200">Welcome back! Please login to your account.</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white py-3 rounded-md font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-gray-900 text-white py-3 rounded-md font-medium hover:bg-gray-800 transition-colors"
            >
